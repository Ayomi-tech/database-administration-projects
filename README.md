...
- REPLACE INTO: This command is crucial. If an existing order_id is updated in the source table (or if we insert a new item for an existing order), REPLACE INTO ensures the existing row in the orders
