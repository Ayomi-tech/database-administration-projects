...
/* order_items table was populated and it Trigger the load of orders table. 
orders table was 10033 rows and increased to 12036 after order_items was updated */


-- Records BEFORE INSERT INTO order_items : 10,033 rows
